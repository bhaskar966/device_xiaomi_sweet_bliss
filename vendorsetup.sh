...
# Common dt
git clone https://github.com/bhaskar966/device_xiaomi_sm6150_bliss.git -b 13.0 device/xiaomi/sm6150-common

# hardware_xiaomi
git clone https://github.com/LineageOS/android_hardware_xiaomi.git -b lineage-20 harware/xiaomi
# Vendor
